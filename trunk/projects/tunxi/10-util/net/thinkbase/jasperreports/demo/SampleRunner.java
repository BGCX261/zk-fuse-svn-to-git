package net.thinkbase.jasperreports.demo;
...
public class SampleRunner implements ReportRunner {
	...
	public JasperPrint fill(HttpServletRequest req, UserAccount user) throws Exception{
		...
		image.setRenderer(
			JRImageRenderer.getInstance(
				JRLoader.loadBytes(this.getClass()
						.getResourceAsStream("jasperreports.gif"))
				)
			);
